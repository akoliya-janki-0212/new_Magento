<?php
class Exam_Reportmanager_Block_Adminhtml_Catalog_Product_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    /* protected function _getStoredFilters()
    {
        ...
        $report = Mage::getModel('exam_reportmanager/report')->getCollection()
            ...
            ->getFirstItem();
        $filtersJson = $report->getFilterData();
        $filters = Mage::helper('core')->jsonDecode($filtersJson);
